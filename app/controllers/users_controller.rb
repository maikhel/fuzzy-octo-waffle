...
before_action :set_user, only: [:show, :edit, :update, :update_password, :destroy]
  ...
  def update
    ...
    respond_to do |format|
      if @user.update(user_params)
        format.html { redirect_to edit_account_path, notice: 'User was successfully updated.' }
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :email, :password, :password_confirmation, :street, :postal_code, :city, :country, :bank_account)
    end
